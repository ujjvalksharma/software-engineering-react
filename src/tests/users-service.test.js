import  UserService from "../services/user-service";
  ...
  describe('createUser', () => {
    ...
    beforeAll(() => {
      ...
      return UserService.deleteUsersByUsername(ripley.username);
    })
  ...
  describe('deleteUsersByUsername', () => {
    ...
    beforeAll(() => {
      ...
      return UserService.createUser(sowell);
    });
  
    // clean up after test runs
    afterAll(() => {
      // remove any data we created
      return UserService.deleteUsersByUsername(sowell.username);
    })
  ...
  describe('findUserById',  () => {
    ...
    beforeAll(() => {
      ...
      return UserService.deleteUsersByUsername(adam.username)
    });
